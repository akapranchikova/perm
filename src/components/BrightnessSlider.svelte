<script>
    ...
    onMount(() => {
        ...
        const updateSizes = () => {
            updateSliderRect();
            animationFrameId = requestAnimationFrame(updateSizes);
        };
...
<div
    class='brightness-slider-container {cssClass}'
...
<style>
    ...
    .brightness-slider-container:focus {
        outline: none;
    }
    ...
    .brightness-slider-container.dragging {
        cursor: grabbing;
    }

    .brightness-slider-container.dragging .slider-fill {
        transition: none;
    }
</style>