<script>
  ...
  const intro = {
    ...
    description:
      "Картина показывает больную...",
    imageUrl: "/activityA/frame_0001.png",
...
<style>
  ...
  /*
  TODO: это стили для слайдера с ползунком, пока закомментированы, потому что здесь здругой слайдер
